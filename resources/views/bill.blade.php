...
<h1 style="float:left;color:yellow;margin-left:0%;">Checkout Form</h1>
<h1 style="color:blue;margin-left:80%;"><a style=" text-decoration:none;"href="/">Return to Home</a></h1>
      ...
      <form action="/create">
        ...
        <div class="row">
          ...
          <div class="col-50">
            ...
            <input type="text" id="cname" name="cardname" required="required" placeholder="John More Doe">
            ...
            <div class="row">
              <div class="col-50">
                ...
                <input type="text" id="expyear" name="expyear" required="required" placeholder="2018">
              </div>
              <div class="col-50">
                <label for="cvv">CVV</label>
                <input type="text" id="cvv" name="cvv" required="required" placeholder="352">
              </div>
            </div>
          </div>
        ...
        <label>
          <input type="checkbox" checked="checked" required="required" name="sameadr"> Shipping address same as billing
        </label>
        <input type="submit" value="Continue to checkout" required="required" class="btn">
      </form>
    </div>
  </div>
  <div class="col-25">
